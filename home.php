   ...
   <head>
	  ...
	  <script>
	   /* Set appliances according to xml file of current state
         	...
         	2) Each device must be of the class corresponding to the room in XML, and the id corresponding to the element
         */
         ...
         function refreshState(){
         	$.ajax({
         					type:"GET",
         					url: "currentState.xml",
         					dataType: "xml",
         					success: function(xml){							
         					$(xml).find('room').each(function(){ //for each room						
         									var roomid = $(this).attr('id');			
         									//Get each appliance state and value
         				...
         				$.ajax({
         					...
         					success: function(xml){			
         						$(xml).find('room').each(function(){ //for each room						
         										var roomid = $(this).attr('id');			
         										$(this).find('appliance').each(function(){
         											var currentID = "#" + $(this).attr('id') + "-state" + "." + roomid;
         											if( currentID == id){
         												var newstate = $(currentID).is(":checked") ? "on" : "off";
         												$(this).find('state').text(newstate);
         												
         												var xmlString=jQ_xmlDocToString($(xml)) //Convert xml to string
         						
         												/* send modified  xml string to server*/    
         												$.post('save_current_state.php', {xml:xmlString },function (response){console.log(response)},'text')
         											}								
         										});									
         									});								
      ...
      <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
         ...
         <div class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
            ...
            <nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
               <a class="mdl-navigation__link mdl-navigation__link--current" href="home.php"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">home</i>Home</a>
         ...
         <main class="mdl-layout__content mdl-color--grey-100">
            ...
            <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" style="position:fixed; right:35px; top:100px;" onclick="alloff()" id="btnturnoff"> All off </button>
                        ...
                        <tr>
                           ...
                           <td>
                              <div  style="float:right;"><label class="mdl-switch mdl-js-switch mdl-js-ripple-effect" for="ceilinglights-state">
                                 <input type="checkbox" id="ceilinglights-state" class="mdl-switch__input livingroom" onclick="applianceChange('#ceilinglights-state.livingroom')">
                        ...
                        <tr>
                           ...
                           <td>
                              <div  style="float:right;"><label class="mdl-switch mdl-js-switch mdl-js-ripple-effect" for="tablelights-state">
                                 <input type="checkbox" id="tablelights-state" class="mdl-switch__input livingroom" onclick="applianceChange('#tablelights-state.livingroom')">
                                 <span class="mdl-switch__label"></span>
                                 </label>
                              </div>
                           </td>
                        ...
                        <tr>
                           ...
                           <td>
                              <div  style="float:right;"><label class="mdl-switch mdl-js-switch mdl-js-ripple-effect" for="sofalights-state">
                                 <input type="checkbox" id="sofalights-state" class="mdl-switch__input livingroom" onclick="applianceChange('#sofalights-state.livingroom')">
                                 <span class="mdl-switch__label"></span>
                                 </label>
                              </div>
                           </td>
                        ...
                        <tr>
                           ...
                           <td>
                              <div  style="float:right;"><label class="mdl-switch mdl-js-switch mdl-js-ripple-effect" for="windows-state">
                                 <input type="checkbox" id="windows-state" class="mdl-switch__input livingroom" onclick="applianceChange('#windows-state.livingroom')">
                                 <span class="mdl-switch__label"></span>
                                 </label>
                              </div>
                           </td>
                        ...
                        <tr>
                           ...
                           <td>
                              <div  style="float:right;"><label class="mdl-switch mdl-js-switch mdl-js-ripple-effect" for="tv-state">
                                 <input type="checkbox" id="tv-state" class="mdl-switch__input livingroom" onclick="applianceChange('#tv-state.livingroom')">
                                 <span class="mdl-switch__label"></span>
                                 </label>
                              </div>
                           </td>
                        ...
                        <tr>
                           ...
                           <td>
                              <div  style="float:right;"><label class="mdl-switch mdl-js-switch mdl-js-ripple-effect" for="loudspeakers-state">
                                 <input type="checkbox" id="loudspeakers-state" class="mdl-switch__input livingroom" onclick="applianceChange('#loudspeakers-state.livingroom')">
                                 <span class="mdl-switch__label"></span>
                                 </label>
                              </div>
                           </td>
                        ...
                        <tr>
                           ...
                           <td>
                              <div  style="float:right;"><label class="mdl-switch mdl-js-switch mdl-js-ripple-effect" for="thermostat-state">
                                 <input type="checkbox" id="thermostat-state" class="mdl-switch__input livingroom" onclick="applianceChange('#thermostat-state.livingroom')" >
                                 <span class="mdl-switch__label"></span>
                                 </label>
                              </div>
                           </td>
                        ...
                        <tr>
                           ...
                           <td>
                              <div  style="float:right;"><label class="mdl-switch mdl-js-switch mdl-js-ripple-effect" for="ventilation-state">
                                 <input type="checkbox" id="ventilation-state" class="mdl-switch__input livingroom" onclick="applianceChange('#ventilation-state.livingroom')">
                                 <span class="mdl-switch__label"></span>
                                 </label>
                              </div>
                           </td>
                        ...
                        <tr>
                           ...
                           <td>
                              <div  style="float:right;"><label class="mdl-switch mdl-js-switch mdl-js-ripple-effect" for="frontdoor-state">
                                 <input type="checkbox" id="frontdoor-state" class="mdl-switch__input livingroom" onclick="applianceChange('#frontdoor-state.livingroom')">
                                 <span class="mdl-switch__label"></span>
                                 </label>
                              </div>
                           </td>
                        ...
                        <tr>
                           ...
                           <td>
                              <div  style="float:right;"><label class="mdl-switch mdl-js-switch mdl-js-ripple-effect" for="backdoor-state">
                                 <input type="checkbox" id="backdoor-state" class="mdl-switch__input livingroom" onclick="applianceChange('#backdoor-state.livingroom')" >
                                 <span class="mdl-switch__label"></span>
                                 </label>
                              </div>
                           </td>
